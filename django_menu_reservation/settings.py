"""
Django settings for django_menu_reservation project.
...
SECRET_KEY = 'django-insecure-98+69d#r!1c+9fwb(myzba8p)om3n(@srkc@f*nicth8y_03ql'
...
ROOT_URLCONF = 'django_menu_reservation.urls'
...
WSGI_APPLICATION = 'django_menu_reservation.wsgi.application'
